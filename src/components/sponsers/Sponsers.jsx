...
const Sponsers = () => {
    return <div className="mt-10 border-y border-textShade py-4">
        <div className="text-center">
          <h1 className="text-4xl font-semibold">Our <span   className="text-main">Sponsers</span></h1>
          <p className="text-textShade mt-3 mx-2 md:mx-0">As a user, it is important to have a positive experience when using a website   or app</p>
        </div>
